        ...
        <div>
            ...
            <main>
                ...
                <div className={styles.container}>
                    <h1>Привет, наш дорогой резидент 🤗</h1>
                    <p>
                        Вот и настало время ярмарки, где ты сможешь потратить свои накопленные <strong>КИБЕРОНЫ💵</strong>
                    </p>
                    <p>Ниже будут представлены все товары нашей ярмарки 🎁</p>
